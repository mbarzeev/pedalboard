...
- b391167: Normalize the files paths in the coverage json files before deploying to .nyc_output dir

All notable changes to this project will be documented in this file.
See [Conventional Commits](https://conventionalcommits.org) for commit guidelines.

## [0.2.4](https://github.com/mbarzeev/pedalboard/compare/@pedalboard/scripts@0.2.3...@pedalboard/scripts@0.2.4) (2026-03-07)

**Note:** Version bump only for package @pedalboard/scripts

## [0.2.3](https://github.com/mbarzeev/pedalboard/compare/@pedalboard/scripts@0.2.1...@pedalboard/scripts@0.2.3) (2026-03-07)
